...
public class CacheLoader {
	...
	public void loadCache() {
		...
		// for (final SimpleEntity simpleEntity :
		// simpleEntityService.getSimpleEntities()) {
		// cacheManager.getCache("simple-entities").putIfAbsent(simpleEntity.getCode(),
		// simpleEntity);
		// }
		//
		// for (final CompositeKeyEntity compositeKeyEntity :
		// compositeKeyEntityService.getCompositeKeyEntities()) {
		// cacheManager.getCache("composite-key-entities").putIfAbsent(
		// new DoubleKey(compositeKeyEntity.getFirstCode(),
		// compositeKeyEntity.getSecondCode()),
		// compositeKeyEntity);
		// }
	}
